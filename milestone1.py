...
def create_movie():
    return {'name': random.choice(['Double Impact', 'Infinite Victory', 'Fist of Surrender', 'Battle of Trouble',
                                   'Extreme Revenge']),
            'director': random.choice(['Jordan Ângela McTaggart', 'Laxman Undine Choudhary', 'Padma Carleton Simonsen',
                                       'Cathleen Wanjiku Niles', 'Seija Alivia Pib']),
